            ...
            <div class="col m9" style="margin-left: 100px;">
                <div class="card red lighten-5">
                    <div class="card-content red-text">
                        <span class="card-title">Room Type Exists</span>
                        <p><strong>Error!</strong> Room Type Exists</p>                             
                    </div>
                    <div class="card-action">                            
                        <a  href="/ProRec/AdministratorController?administrator_action=go_to_add_room_type&sessionId=<%=sessionId%>"><< Back to Add Room Type</a> 
                    </div>
                </div>
            </div> 
